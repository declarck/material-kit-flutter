      ...
      Padding(
        ...
        child: SafeArea(
          ...
          children: <Widget>[
            Padding(
              ...
              child: Center(
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                    children: <Widget>[
                  Image.asset("assets/img/albinasoft-logo-blue.png", scale: 1),
                ]),
              ),
            ),
            Padding(
            ...
            Divider(color: MaterialColors.blueSoftLightest, thickness: 1, endIndent: 100, indent: 100, height: 30,),
            Padding(
              padding: const EdgeInsets.all(0),
              child: Text.rich(TextSpan(
                ...
                children: [
                  FlatButton(
                    ...
                    child: Padding(
                        ...
                        child:Image.asset("assets/img/albinasoft-title.png", scale: 1.5),),
                  ),
                  FlatButton(
                    textColor: Colors.white,
                    color: Colors.green,
